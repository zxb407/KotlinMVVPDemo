    ...
    private void initRecyclerView() {
        ...
        rvPhotos.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                tvNumber.setText(String.format(Locale.CHINA, getString(R.string.preview_current_number_easy_photos), lastPosition + 1, photos.size()));
                toggleSelector();
        ...
        tvNumber.setText(String.format(Locale.CHINA, getString(R.string.preview_current_number_easy_photos), index + 1, photos.size()));
    }
...
//        }
    ...
    private void updateSelector() {
        ...
        if (unable) {
            ...
            Toast.makeText(this, String.format(Locale.CHINA, getString(R.string.selector_reach_max_hint_easy_photos), Setting.count), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void shouldShowMenuDone() {
        if (Result.isEmpty()) {
            ...
            tvDone.setText(String.format(Locale.CHINA, getString(R.string.selector_action_done_easy_photos), Result.count(), Setting.count));
        }
    }
